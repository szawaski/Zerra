...
const IWeatherQueryProvider = {
    ...
    GetWeatherSync: function(cancellationToken, onComplete, onFail) {
        Bus.Call("IWeatherQueryProvider", "GetWeatherSync", [cancellationToken], WeatherModelType, false, onComplete, onFail);
    },
