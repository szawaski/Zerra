...
namespace ZerraDemo.Domain.Generated
{
    public class PetModelTypeDetail : TypeDetailTGenerationBase<PetModel>
    {
        ...
        protected override Func<ConstructorDetail<PetModel>[]> CreateConstructorDetails => () => [
            new PetModelConstructorDetail(locker)
        ];
        ...
        {
            public PetModelConstructorDetail(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_ID(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_Name(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_Breed(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_Species(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_LastEaten(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_AmountEaten(object locker) : base(locker) { }
        ...
        {
            public PetModelMemberDetail_LastPooped(object locker) : base(locker) { }
