...
{
    public sealed class Withdraw2CommandTypeDetail : TypeDetailTGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command>
    {               
        ...
        public override Func<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command> Creator => () => new ZerraDemo.Domain.Ledger2.Command.Withdraw2Command();
        ...
        public override Func<object> CreatorBoxed => () => new ZerraDemo.Domain.Ledger2.Command.Withdraw2Command();
        public override bool HasCreatorBoxed => true;

        protected override Func<MethodDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command>[]> CreateMethodDetails => () => [];

        protected override Func<ConstructorDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command>[]> CreateConstructorDetails => () => [];
        ...
        public sealed class AccountIDMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid> Getter => (x) => x.AccountID;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid> Setter => (x, value) => x.AccountID = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).AccountID;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).AccountID = (System.Guid)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid>?> CreateBackingFieldDetail => () => new _AccountID_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class AmountMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal> Getter => (x) => x.Amount;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal> Setter => (x, value) => x.Amount = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).Amount;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).Amount = (decimal)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal>?> CreateBackingFieldDetail => () => new _Amount_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class DescriptionMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?> Getter => (x) => x.Description;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?> Setter => (x, value) => x.Description = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).Description;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.Ledger2.Command.Withdraw2Command)x).Description = (string?)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?>?> CreateBackingFieldDetail => () => new _Description_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class _AccountID_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, System.Guid>?> CreateBackingFieldDetail => () => null;
        }
        public sealed class _Amount_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, decimal>?> CreateBackingFieldDetail => () => null;
        }
        public sealed class _Description_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger2.Command.Withdraw2Command, string?>?> CreateBackingFieldDetail => () => null;
        }
    }
}