...
namespace ZerraDemo.Domain.WeatherCached.Commands.SourceGeneration
{
    public sealed class SetWeatherCachedCommandTypeDetail : TypeDetailTGenerationBase<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand>
    {               
        ...
        public override Func<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand> Creator => () => new ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand();
        ...
        public override Func<object> CreatorBoxed => () => new ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand();
        public override bool HasCreatorBoxed => true;

        protected override Func<MethodDetail<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand>[]> CreateMethodDetails => () => [];

        protected override Func<ConstructorDetail<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand>[]> CreateConstructorDetails => () => [];

        protected override Func<MemberDetail[]> CreateMemberDetails => () => [new WeatherTypeMemberDetail(locker, LoadMemberInfo)];


        public sealed class WeatherTypeMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType>
        {
            ...
            public override Func<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType> Getter => (x) => x.WeatherType;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType> Setter => (x, value) => x.WeatherType = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand)x).WeatherType;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand)x).WeatherType = (ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType>?> CreateBackingFieldDetail => () => new _WeatherType_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class _WeatherType_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.WeatherCached.Commands.SetWeatherCachedCommand, ZerraDemo.Domain.WeatherCached.Constants.WeatherCachedType>?> CreateBackingFieldDetail => () => null;
        }
    }
}