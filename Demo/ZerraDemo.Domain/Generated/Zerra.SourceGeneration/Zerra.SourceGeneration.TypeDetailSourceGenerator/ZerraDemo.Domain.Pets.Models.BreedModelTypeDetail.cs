...
{
    public sealed class BreedModelTypeDetail : TypeDetailTGenerationBase<ZerraDemo.Domain.Pets.Models.BreedModel>
    {               
        ...
        public override Func<ZerraDemo.Domain.Pets.Models.BreedModel> Creator => () => new ZerraDemo.Domain.Pets.Models.BreedModel();
        ...
        public override Func<object> CreatorBoxed => () => new ZerraDemo.Domain.Pets.Models.BreedModel();
        public override bool HasCreatorBoxed => true;

        protected override Func<MethodDetail<ZerraDemo.Domain.Pets.Models.BreedModel>[]> CreateMethodDetails => () => [];

        protected override Func<ConstructorDetail<ZerraDemo.Domain.Pets.Models.BreedModel>[]> CreateConstructorDetails => () => [];
        ...
        public sealed class IDMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid>
        {
            ...
            public override Func<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid> Getter => (x) => x.ID;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid> Setter => (x, value) => x.ID = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Pets.Models.BreedModel)x).ID;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.Pets.Models.BreedModel)x).ID = (System.Guid)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid>?> CreateBackingFieldDetail => () => new _ID_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class NameMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Pets.Models.BreedModel, string?>
        {
            ...
            public override Func<ZerraDemo.Domain.Pets.Models.BreedModel, string?> Getter => (x) => x.Name;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Pets.Models.BreedModel, string?> Setter => (x, value) => x.Name = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Pets.Models.BreedModel)x).Name;
            public override bool HasGetterBoxed => true;

            public override Action<object, object?> SetterBoxed => (x, value) => ((ZerraDemo.Domain.Pets.Models.BreedModel)x).Name = (string?)value!;
            public override bool HasSetterBoxed => true;

            protected override Func<MemberDetail<ZerraDemo.Domain.Pets.Models.BreedModel, string?>?> CreateBackingFieldDetail => () => new _Name_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class _ID_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Pets.Models.BreedModel, System.Guid>?> CreateBackingFieldDetail => () => null;
        }
        public sealed class _Name_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Pets.Models.BreedModel, string?>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Pets.Models.BreedModel, string?>?> CreateBackingFieldDetail => () => null;
        }
    }
}