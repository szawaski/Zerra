...
namespace ZerraDemo.Domain.Ledger1.Command.SourceGeneration
{
    ...
    {               
        ...
        public sealed class AccountIDMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, System.Guid>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, System.Guid>?> CreateBackingFieldDetail => () => new _AccountID_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class AmountMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, decimal>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, decimal>?> CreateBackingFieldDetail => () => new _Amount_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class DescriptionMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, string?>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, string?>?> CreateBackingFieldDetail => () => new _Description_k__BackingFieldMemberDetail(locker, loadMemberInfo);
        }
        public sealed class _AccountID_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, System.Guid>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, System.Guid>?> CreateBackingFieldDetail => () => null;
        }
        public sealed class _Amount_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, decimal>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, decimal>?> CreateBackingFieldDetail => () => null;
        }
        public sealed class _Description_k__BackingFieldMemberDetail : PrivateMemberDetailGenerationBase<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, string?>
        {
            ...
            protected override Func<MemberDetail<ZerraDemo.Domain.Ledger1.Command.Deposit1Command, string?>?> CreateBackingFieldDetail => () => null;
        }
    }
}