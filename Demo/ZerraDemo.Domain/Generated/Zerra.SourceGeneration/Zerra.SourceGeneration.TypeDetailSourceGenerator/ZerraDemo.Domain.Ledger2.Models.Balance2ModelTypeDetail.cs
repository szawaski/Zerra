...
{
    public sealed class Balance2ModelTypeDetail : TypeDetailTGenerationBase<ZerraDemo.Domain.Ledger2.Models.Balance2Model>
    {               
        ...
        public override Func<ZerraDemo.Domain.Ledger2.Models.Balance2Model> Creator => () => new ZerraDemo.Domain.Ledger2.Models.Balance2Model();
        ...
        public override Func<object> CreatorBoxed => () => new ZerraDemo.Domain.Ledger2.Models.Balance2Model();
        public override bool HasCreatorBoxed => true;

        protected override Func<MethodDetail<ZerraDemo.Domain.Ledger2.Models.Balance2Model>[]> CreateMethodDetails => () => [];

        protected override Func<ConstructorDetail<ZerraDemo.Domain.Ledger2.Models.Balance2Model>[]> CreateConstructorDetails => () => [];
        ...
        public sealed class AccountIDMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.Guid>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.Guid> Getter => (x) => x.AccountID;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.Guid> Setter => (x, value) => x.AccountID = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Models.Balance2Model)x).AccountID;
        ...
        public sealed class BalanceMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal> Getter => (x) => x.Balance;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal> Setter => (x, value) => x.Balance = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Models.Balance2Model)x).Balance;
            public override bool HasGetterBoxed => true;
        ...
        public sealed class LastTransactionDateMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.DateTime?>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.DateTime?> Getter => (x) => x.LastTransactionDate;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Models.Balance2Model, System.DateTime?> Setter => (x, value) => x.LastTransactionDate = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Models.Balance2Model)x).LastTransactionDate;
            public override bool HasGetterBoxed => true;
        ...
        public sealed class LastTransactionAmountMemberDetail : MemberDetailGenerationBase<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal?>
        {
            ...
            public override Func<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal?> Getter => (x) => x.LastTransactionAmount;
            public override bool HasGetter => true;

            public override Action<ZerraDemo.Domain.Ledger2.Models.Balance2Model, decimal?> Setter => (x, value) => x.LastTransactionAmount = value;
            public override bool HasSetter => true;

            public override IReadOnlyList<Attribute> Attributes => [];

            public override Func<object, object?> GetterBoxed => (x) => ((ZerraDemo.Domain.Ledger2.Models.Balance2Model)x).LastTransactionAmount;
            public override bool HasGetterBoxed => true;
