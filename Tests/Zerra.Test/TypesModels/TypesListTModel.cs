...
namespace Zerra.Test
{
    public class TypesListTModel
    {
        ...
        public List<SimpleModel> ClassListT { get; set; }
        public List<SimpleModel> ClassListTEmpty { get; set; }
        public List<SimpleModel> ClassListTNull { get; set; }

        public static TypesListTModel Create()
        {
            var model = new TypesListTModel()
            {
                ...
                EnumListTEmpty = new List<EnumModel>(0),
                EnumListTNull = null,

                EnumListTNullable = new List<EnumModel?>() { EnumModel.EnumItem1, null, EnumModel.EnumItem3 },
                EnumListTNullableEmpty = new List<EnumModel?>(0),
                EnumListTNullableNull = null,

                ClassListT = new List<SimpleModel>() { new SimpleModel { Value1 = 10, Value2 = "S-10" }, new SimpleModel { Value1 = 11, Value2 = "S-11" } },
                ClassListTEmpty = new List<SimpleModel>(0),
                ClassListTNull = null,
            };
            return model;
        }
