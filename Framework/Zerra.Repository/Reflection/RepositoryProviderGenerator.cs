...
namespace Zerra.Repository.Reflection
{
    public static class RepositoryProviderGenerator
    {
        ...
        public static Type? GenerateTransactStoreProvider<T>(Type type, bool eventLinking, bool queryLinking, bool persistLinking)
        {
            ...
            if (Discovery.GetClassByInterface(interfaceType, false) is null)
                return null;
        ...
        public static Type? GenerateEventStoreProvider<T>(Type type, bool eventLinking, bool queryLinking, bool persistLinking)
        {
            var entityType = typeof(T);
        ...
        public static Type? GenerateEventStoreAggregate<T>(Type type)
        {
