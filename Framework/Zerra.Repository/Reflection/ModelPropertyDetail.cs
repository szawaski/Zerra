...
namespace Zerra.Repository.Reflection
{
    public sealed class ModelPropertyDetail
    {
        ...
        internal ModelPropertyDetail(MemberDetail memberDetail, bool declaringTypeIsDataSourceEntity)
        {
            ...
            var entityAttribute = memberDetail.TypeDetailBoxed.Attributes.Select(x => x as EntityAttribute).Where(x => x != null).FirstOrDefault();
            ...
            this.IsDataSourceNotNull = storePropertyAttribute != null ? storePropertyAttribute.NotNull : (InnerType.IsValueType && !memberDetail.TypeDetailBoxed.IsNullable);
