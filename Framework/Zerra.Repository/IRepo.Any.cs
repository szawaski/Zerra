...
namespace Zerra.Repository
{
    public partial interface IRepo
    {
        ...
        bool Any<TModel>(Expression<Func<TModel, bool>>? where = null) where TModel : class, new()
        ...
        async Task<bool> AnyAsync<TModel>(Expression<Func<TModel, bool>>? where = null) where TModel : class, new()
