...
namespace Zerra.Repository
{
    ...
    public sealed class EventStoreEntityAttribute<T> : BaseGenerateAttribute
    {
        ...
        public override Type? Generate(Type type) => RepositoryProviderGenerator.GenerateEventStoreProvider<T>(type, eventLinking == true, queryLinking == true, persistLinking == true);
    }
}
