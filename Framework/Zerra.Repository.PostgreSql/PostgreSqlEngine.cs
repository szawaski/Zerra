...
{
    public sealed class PostgreSqlEngine : ITransactStoreEngine
    {
        ...
        private static void WriteSqlTypeFromColumnAsNullable(StringBuilder sb, SqlColumnType sqlColumn)
        {
            switch (sqlColumn.DataType)
            {
                ...
                case "varbinary":
                    ...
                    break;
                default:
                    throw new NotImplementedException($"{nameof(ITransactStoreEngine.BuildStoreFromModels)} {nameof(PostgreSqlEngine)} type {sqlColumn.DataType} not implemented.");
            }
