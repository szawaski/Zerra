...
{
    internal sealed class MemberAndParameterNameComparer : IEqualityComparer<string>
    {
        private const int firstUpperCase = 65;
        private const int lastUpperCase = 90;

        public static readonly MemberAndParameterNameComparer Instance = new();
        private MemberAndParameterNameComparer() { }
