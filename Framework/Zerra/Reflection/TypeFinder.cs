...
{
    /// <summary>
    /// Provides functionality for resolving and registering types by their name strings.
    /// Supports caching of type lookups for performance optimization.
    /// </summary>
...
#pragma warning restore IL2057 // Unrecognized value passed to the parameter of method. It's not possible to guarantee the availability of the target type.
        ...
        /// <summary>
        /// Registers a type for lookup by its assembly-qualified name.
        /// Caches the type so it can be resolved by its name.
