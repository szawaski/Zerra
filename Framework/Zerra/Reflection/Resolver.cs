...
namespace Zerra.Reflection
{
    public static class Resolver
    {
        ...
        private static object GetSingleGeneric(Type type, bool throwException)
        {
            ...
            var provider = genericMethodProviderManagerTryGetSingle.CallerBoxed(null, [throwException])!;
            return provider;
        }
        ...
        private static object GetNewGeneric(Type type, bool throwException)
        {
            ...
            var provider = genericMethodProviderManagerTryGetNew.CallerBoxed(null, [throwException])!;
            return provider;
        }
