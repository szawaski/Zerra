...
{
    internal sealed class ByteConverterTimeOnlyIReadOnlySet<TParent> : ByteConverter<TParent, IReadOnlySet<TimeOnly>>
    {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, in IReadOnlySet<TimeOnly> value)
        {
