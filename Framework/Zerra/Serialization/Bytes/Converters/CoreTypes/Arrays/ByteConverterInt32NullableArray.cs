...
{
    internal sealed class ByteConverterInt32NullableArray<TParent> : ByteConverter<TParent, int?[]>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out int?[]? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, int?[]? value)
        {
