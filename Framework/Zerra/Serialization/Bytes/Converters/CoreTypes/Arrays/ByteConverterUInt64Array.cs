...
{
    internal sealed class ByteConverterUInt64Array<TParent> : ByteConverter<TParent, ulong[]>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ulong[]? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ulong[]? value)
        {
