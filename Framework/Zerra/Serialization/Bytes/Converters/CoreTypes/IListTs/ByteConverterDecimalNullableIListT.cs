...
{
    internal sealed class ByteConverterDecimalNullableIList<TParent> : ByteConverter<TParent, IList<decimal?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IList<decimal?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IList<decimal?>? value)
        {
