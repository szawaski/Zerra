...
namespace Zerra.Serialization.Bytes.Converters.CoreTypes.IListTs
{
    ...
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, out IList<Guid?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, in IList<Guid?> value)
        {
