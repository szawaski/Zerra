...
{
    internal sealed class ByteConverterDateTimeNullableIList<TParent> : ByteConverter<TParent, IList<DateTime?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IList<DateTime?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IList<DateTime?>? value)
        {
