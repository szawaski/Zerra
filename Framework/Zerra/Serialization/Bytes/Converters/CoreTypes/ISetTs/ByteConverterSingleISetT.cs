...
{
    internal sealed class ByteConverterSingleISet<TParent> : ByteConverter<TParent, ISet<float>>
    {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, in ISet<float> value)
        {
