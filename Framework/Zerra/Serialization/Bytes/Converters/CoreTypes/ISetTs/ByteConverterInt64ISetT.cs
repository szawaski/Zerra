...
namespace Zerra.Serialization.Bytes.Converters.CoreTypes.ISetTs
{
    ...
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<long>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<long>? value)
        {
