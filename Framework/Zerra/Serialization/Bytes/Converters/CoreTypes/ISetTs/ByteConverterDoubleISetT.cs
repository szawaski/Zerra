...
{
    internal sealed class ByteConverterDoubleISet<TParent> : ByteConverter<TParent, ISet<double>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<double>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<double>? value)
        {
