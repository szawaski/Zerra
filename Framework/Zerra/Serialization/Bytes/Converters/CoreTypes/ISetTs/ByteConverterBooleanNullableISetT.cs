...
{
    internal sealed class ByteConverterBooleanNullableISet<TParent> : ByteConverter<TParent, ISet<bool?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<bool?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<bool?>? value)
        {
