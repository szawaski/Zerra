...
{
    internal sealed class ByteConverterByteNullableISet<TParent> : ByteConverter<TParent, ISet<byte?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<byte?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<byte?>? value)
        {
