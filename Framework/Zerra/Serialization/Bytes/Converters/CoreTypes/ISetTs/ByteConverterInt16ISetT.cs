...
{
    internal sealed class ByteConverterInt16ISet<TParent> : ByteConverter<TParent, ISet<short>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<short>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<short>? value)
        {
