...
{
    internal sealed class ByteConverterDateTimeNullableISet<TParent> : ByteConverter<TParent, ISet<DateTime?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<DateTime?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<DateTime?>? value)
        {
