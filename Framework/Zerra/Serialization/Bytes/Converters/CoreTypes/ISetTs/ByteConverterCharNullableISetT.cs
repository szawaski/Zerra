...
{
    internal sealed class ByteConverterCharNullableISet<TParent> : ByteConverter<TParent, ISet<char?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<char?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<char?>? value)
        {
