...
{
    internal sealed class ByteConverterUInt16ISet<TParent> : ByteConverter<TParent, ISet<ushort>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<ushort>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<ushort>? value)
        {
