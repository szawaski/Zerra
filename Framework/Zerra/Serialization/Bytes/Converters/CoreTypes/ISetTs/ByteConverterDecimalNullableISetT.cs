...
{
    internal sealed class ByteConverterDecimalNullableISet<TParent> : ByteConverter<TParent, ISet<decimal?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ISet<decimal?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ISet<decimal?>? value)
        {
