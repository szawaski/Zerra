...
{
    internal sealed class ByteConverterByteNullableIReadOnlyCollection<TParent> : ByteConverter<TParent, IReadOnlyCollection<byte?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyCollection<byte?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyCollection<byte?>? value)
        {
