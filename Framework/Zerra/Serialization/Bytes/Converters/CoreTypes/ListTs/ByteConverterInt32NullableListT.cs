...
{
    internal sealed class ByteConverterInt32NullableList<TParent> : ByteConverter<TParent, List<int?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out List<int?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, List<int?>? value)
        {
