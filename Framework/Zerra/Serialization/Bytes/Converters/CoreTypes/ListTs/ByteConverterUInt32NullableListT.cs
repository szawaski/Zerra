...
{
    internal sealed class ByteConverterUInt32NullableList<TParent> : ByteConverter<TParent, List<uint?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out List<uint?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, List<uint?>? value)
        {
