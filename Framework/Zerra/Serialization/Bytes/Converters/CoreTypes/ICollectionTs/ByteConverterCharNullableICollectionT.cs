...
{
    internal sealed class ByteConverterCharNullableICollection<TParent> : ByteConverter<TParent, ICollection<char?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<char?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<char?>? value)
        {
