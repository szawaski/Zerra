...
namespace Zerra.Serialization.Bytes.Converters.ICollections
{
    internal sealed class ByteConverterDateOnlyNullableICollection<TParent> : ByteConverter<TParent, ICollection<DateOnly?>>
    {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, in ICollection<DateOnly?> value)
        {
