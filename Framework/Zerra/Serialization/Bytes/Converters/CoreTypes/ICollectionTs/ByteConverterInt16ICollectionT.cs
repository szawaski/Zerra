...
namespace Zerra.Serialization.Bytes.Converters.CoreTypes.ICollectionTs
{
    ...
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<short>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<short>? value)
        {
