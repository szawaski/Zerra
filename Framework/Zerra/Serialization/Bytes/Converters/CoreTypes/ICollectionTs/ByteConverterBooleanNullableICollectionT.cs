...
{
    internal sealed class ByteConverterBooleanNullableICollection<TParent> : ByteConverter<TParent, ICollection<bool?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<bool?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<bool?>? value)
        {
