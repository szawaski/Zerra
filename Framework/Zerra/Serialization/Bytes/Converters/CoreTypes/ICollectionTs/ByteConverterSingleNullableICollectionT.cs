...
{
    internal sealed class ByteConverterSingleNullableICollection<TParent> : ByteConverter<TParent, ICollection<float?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<float?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<float?>? value)
        {
