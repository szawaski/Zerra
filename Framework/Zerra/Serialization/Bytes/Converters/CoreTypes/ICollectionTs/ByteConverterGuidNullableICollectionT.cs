...
{
    internal sealed class ByteConverterGuidNullableICollection<TParent> : ByteConverter<TParent, ICollection<Guid?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<Guid?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<Guid?>? value)
        {
