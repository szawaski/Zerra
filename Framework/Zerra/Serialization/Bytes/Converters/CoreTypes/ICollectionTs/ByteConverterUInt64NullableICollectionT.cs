...
{
    internal sealed class ByteConverterUInt64NullableICollection<TParent> : ByteConverter<TParent, ICollection<ulong?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<ulong?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<ulong?>? value)
        {
