...
{
    internal sealed class ByteConverterDecimalNullableICollection<TParent> : ByteConverter<TParent, ICollection<decimal?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<decimal?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<decimal?>? value)
        {
