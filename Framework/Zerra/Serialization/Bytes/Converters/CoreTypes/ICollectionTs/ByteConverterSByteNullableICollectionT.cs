...
{
    internal sealed class ByteConverterSByteNullableICollection<TParent> : ByteConverter<TParent, ICollection<sbyte?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out ICollection<sbyte?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, ICollection<sbyte?>? value)
        {
