...
{
    internal sealed class ByteConverterUInt64NullableIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<ulong?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<ulong?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<ulong?>? value)
        {
