...
{
    internal sealed class ByteConverterByteNullableIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<byte?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<byte?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<byte?>? value)
        {
