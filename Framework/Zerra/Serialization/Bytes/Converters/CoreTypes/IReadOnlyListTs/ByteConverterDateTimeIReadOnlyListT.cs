...
{
    internal sealed class ByteConverterDateTimeIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<DateTime>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<DateTime>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<DateTime>? value)
        {
