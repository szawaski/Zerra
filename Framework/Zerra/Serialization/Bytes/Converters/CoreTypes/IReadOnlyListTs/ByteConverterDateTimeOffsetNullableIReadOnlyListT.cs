...
{
    internal sealed class ByteConverterDateTimeOffsetNullableIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<DateTimeOffset?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<DateTimeOffset?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<DateTimeOffset?>? value)
        {
