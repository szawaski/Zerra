...
{
    internal sealed class ByteConverterDoubleNullableIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<double?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<double?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<double?>? value)
        {
