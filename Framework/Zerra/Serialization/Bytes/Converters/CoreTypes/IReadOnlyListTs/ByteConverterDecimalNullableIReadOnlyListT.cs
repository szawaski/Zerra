...
{
    internal sealed class ByteConverterDecimalNullableIReadOnlyList<TParent> : ByteConverter<TParent, IReadOnlyList<decimal?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IReadOnlyList<decimal?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IReadOnlyList<decimal?>? value)
        {
