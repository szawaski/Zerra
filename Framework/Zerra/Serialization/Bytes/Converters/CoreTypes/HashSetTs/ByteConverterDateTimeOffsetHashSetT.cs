...
{
    internal sealed class ByteConverterDateTimeOffsetHashSet<TParent> : ByteConverter<TParent, HashSet<DateTimeOffset>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out HashSet<DateTimeOffset>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, HashSet<DateTimeOffset>? value)
        {
