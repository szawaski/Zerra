...
{
    internal sealed class ByteConverterUInt16HashSet<TParent> : ByteConverter<TParent, HashSet<ushort>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out HashSet<ushort>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, HashSet<ushort>? value)
        {
