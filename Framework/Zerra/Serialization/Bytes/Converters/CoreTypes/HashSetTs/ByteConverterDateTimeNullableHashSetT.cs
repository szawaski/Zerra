...
namespace Zerra.Serialization.Bytes.Converters.CoreTypes.HashSetTs
{
    ...
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, out HashSet<DateTime?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, in HashSet<DateTime?> value)
        {
