...
{
    internal sealed class ByteConverterUInt64NullableHashSet<TParent> : ByteConverter<TParent, HashSet<ulong?>>
    {
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out HashSet<ulong?>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, HashSet<ulong?>? value)
        {
