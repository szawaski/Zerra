...
namespace Zerra.Serialization.Bytes.Converters.Collections.Dictionaries
{
        ...
        where TKey : notnull
    {
        ...
        protected override sealed bool TryReadValue(ref ByteReader reader, ref ReadState state, bool nullFlags, out IDictionary<TKey, TValue>? value)
        {
        ...
        protected override sealed bool TryWriteValue(ref ByteWriter writer, ref WriteState state, bool nullFlags, IDictionary<TKey, TValue>? value)
        {
