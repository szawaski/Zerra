...
namespace Zerra.Serialization.Bytes.Converters.Collections.Lists
{
    internal sealed class ByteConverterIReadOnlyListT<TParent, TValue> : ByteConverter<TParent, IReadOnlyList<TValue>>
    {
        ...
        protected override sealed void Setup()
        {
            ...
            readConverter = ByteConverterFactory<IList<TValue>>.Get(valueTypeDetail, nameof(ByteConverterIReadOnlyListT<TParent, TValue>), null, Setter);
            writeConverter = ByteConverterFactory<IEnumerator<TValue>>.Get(valueTypeDetail, nameof(ByteConverterIReadOnlyListT<TParent, TValue>), Getter, null);
        }
