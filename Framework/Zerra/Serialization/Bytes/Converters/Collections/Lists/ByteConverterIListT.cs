...
{
    internal sealed class ByteConverterIListT<TValue> : ByteConverter<IList<TValue>>
    {
        ...
        protected override sealed void Setup()
        {
            ...
            converter = ByteConverterFactory.Get(valueTypeDetail, nameof(ByteConverterIListT<TValue>), Getter, Setter);
        }
