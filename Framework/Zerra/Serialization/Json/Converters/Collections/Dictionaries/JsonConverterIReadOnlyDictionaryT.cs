...
{
    internal sealed class JsonConverterIReadOnlyDictionaryT<TKey, TValue> : JsonConverter<IReadOnlyDictionary<TKey, TValue>>
        where TKey : notnull
    {
        ...
        protected override sealed void Setup()
        {
            ...
            else
            {
                ...
                converter = JsonConverterFactory.Get(keyValuePairTypeDetail, nameof(JsonConverterIReadOnlyDictionaryT<TKey, TValue>), Getter, Setter);
            }
        }

        protected override sealed bool TryReadValue(ref JsonReader reader, ref ReadState state, JsonToken token, out IReadOnlyDictionary<TKey, TValue>? value)
        {
