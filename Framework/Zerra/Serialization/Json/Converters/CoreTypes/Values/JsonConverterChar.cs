...
namespace Zerra.Serialization.Json.Converters.CoreTypes.Values
{
    ...
    {
        protected override sealed bool TryReadValue(ref CharReader reader, ref ReadState state, out char value)
        {
        ...
        protected override sealed bool TryWriteValue(ref CharWriter writer, ref WriteState state, char value)
