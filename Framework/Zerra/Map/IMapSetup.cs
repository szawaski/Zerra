...
namespace Zerra.Map
{
    ...
    public interface IMapSetup<TSource, TTarget>
    {
        ...
        /// <summary>
        /// Undefines a mapping that may have been automatically or manually mapped by name.
        /// </summary>
        /// <param name="property">An expression pointing to the target property.</param>
        void Undefine(Expression<Func<TTarget, object?>> property);
        /// <summary>
        /// Undefines a mapping that may have been automatically or manually mapped by name both directions.
        /// </summary>
        /// <param name="property">An expression pointing to the target property.</param>
        /// <param name="sourceProperty">An expression pointing to the source property.</param>
        void UndefineTwoWay(Expression<Func<TTarget, object?>> property, Expression<Func<TSource, object?>> sourceProperty);
        /// <summary>
        /// Undefineds all properties that may have been automatically or manually mapped.
        /// </summary>
        void UndefineAll();
    }
}
