...
namespace Zerra.CQRS
{
    ...
    /// </summary>
    public delegate Task<RemoteQueryCallResponse> QueryHandlerDelegate(Type interfaceName, string methodName, byte[]?[] arguments, string source, ISerializer serializer, CancellationToken cancellationToken);
}