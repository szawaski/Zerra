    ...
    public partial class AzureEventGridConsumer
    {
        public class EventConsumer : IDisposable
        {
            ...
            retry:
                ...
                try
                {
                    await AzureEventGridCommon.EnsureTopic(topic);
                    ...
                    using (var consumer = new ConsumerBuilder<string, byte[]>(consumerConfig).Build())
                    {
                        ...
                        for (; ; )
                        {
                            try
                            {
                                ...
                                if (consumerResult.Message.Key == AzureEventGridCommon.MessageKey)
                                {
                                    ...
                                    var message = AzureEventGridCommon.Deserialize<AzureEventGridEventMessage>(body);
