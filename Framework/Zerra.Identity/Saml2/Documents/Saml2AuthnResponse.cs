...
{
    public class Saml2AuthnResponse : Saml2Document
    {
        ...
        public string NotBefore { get; protected set; }
        public string NotOnOrAfter { get; protected set; }
        public string AssertionID { get; protected set; }
        public string SubjectNameID { get; protected set; }
        public string SessionIndex { get; protected set; }
