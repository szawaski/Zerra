...
{
    internal class OAuth2QueryBinding : OAuth2Binding
    {
        public override BindingType BindingType => BindingType.Query;

        internal OAuth2QueryBinding(OAuth2Document document)
        {
        ...
        internal OAuth2QueryBinding(IdentityHttpRequest request, BindingDirection bindingDirection)
        {
